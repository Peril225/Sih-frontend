...
data = {
    "from": None, "to": None, "state": None, "standard": None
}
head = {"Content-Type": "application/json"}
desp = ['Engineering & Technology', 'Aeronautical Engineering', 'Agriculture Engineering', 'Architecture', 'Chemical Engineering', 'Civil Engineering', 'Computer Engineering', 'Dairy Technology', 'Electrical Engineering', 'Electronics Engineering', 'Food Technology', 'Marine Engineering',
