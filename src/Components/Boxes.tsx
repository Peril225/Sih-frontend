    ...
    <div>
      <div className='BOXES md:flex  space-x-3'>
        <div className='flex space-x-3'>
          ...
          >
            <div className='text-red-600'>Drop Out Percent</div>
          ...
          >
            ...
            <div className=''>2022 Stats</div>
            <div className='pt-5 text-green-700 text-lg'>+4.5 %</div>
        ...
        <div className='flex  space-x-3'>
          ...
          >
            ...
            <div className=''>2022 Stats</div>
            <div className='pt-5 text-blue-700 text-lg'>+6.8 %</div>
            <div className='text-blue-600 text-2xl '>21,000</div>
          </div>
          <div
          ...
          >
            ...
            <div className=''>2022 Stats</div>
            <div className='pt-5 text-gray-700 text-lg'>+3.6 %</div>
            <div className='text-gray-600 text-2xl '>18,000</div>
          </div>
        </div>
      </div>
    </div>
