...
export const DATABOX: any = {
  "Andaman and Nicobar Islands": [25, 70, 71, 35],
  "Andhra Pradesh": [27, 74, 89, 42],
  "Arunachal Pradesh": [11, 75, 81, 35],
  Assam: [21, 85, 71, 45],
  Bihar: [19, 84, 87, 47],
  Chandigarh: [19, 85, 88, 45],
  Chhattisgarh: [21, 87, 85, 58],
  "Dadra and Nagar Haveli": [24, 88, 70, 43],
  "Daman and Diu": [23, 76, 85, 59],
  Delhi: [17, 86, 80, 48],
  Goa: [27, 83, 82, 41],
  Gujarat: [19, 89, 90, 45],
  Haryana: [10, 86, 70, 52],
  "Himachal Pradesh": [12, 83, 78, 52],
  "Jammu and Kashmir": [19, 70, 78, 38],
  Jharkhand: [26, 71, 78, 32],
  Karnataka: [21, 90, 75, 43],
  Kerala: [12, 84, 75, 54],
  Lakshadweep: [13, 79, 77, 31],
  "Madhya Pradesh": [30, 83, 87, 54],
  Maharashtra: [15, 73, 76, 49],
  Manipur: [11, 72, 89, 59],
  Meghalaya: [10, 78, 76, 33],
  Mizoram: [27, 90, 87, 31],
  Nagaland: [22, 72, 74, 47],
  Odisha: [27, 89, 84, 46],
  Puducherry: [22, 90, 85, 37],
  Punjab: [27, 87, 84, 40],
  Rajasthan: [21, 75, 84, 40],
  Sikkim: [19, 74, 83, 34],
  "Tamil Nadu": [17, 85, 75, 41],
  Telangana: [20, 74, 78, 44],
  Tripura: [11, 77, 79, 32],
  "Uttar Pradesh": [16, 74, 80, 36],
  Uttarakhand: [20, 74, 85, 31],
};

export const DataFORPIRHOME: any = {
  "Andaman and Nicobar Islands": [27, 50, 23],
  "Andhra Pradesh": [35, 31, 34],
  "Arunachal Pradesh": [32, 33, 35],
  Assam: [30, 39, 31],
  Bihar: [31, 37, 32],
  Chandigarh: [34, 35, 31],
  Chhattisgarh: [28, 45, 27],
  "Dadra and Nagar Haveli": [24, 40, 36],
  "Daman and Diu": [32, 45, 23],
  Delhi: [21, 21, 58],
  Goa: [39, 33, 28],
  Gujarat: [20, 36, 44],
  Haryana: [21, 26, 53],
  "Himachal Pradesh": [22, 43, 35],
  "Jammu and Kashmir": [29, 21, 50],
  Jharkhand: [32, 46, 22],
  Karnataka: [30, 21, 49],
  Kerala: [27, 22, 51],
  Lakshadweep: [22, 40, 38],
  "Madhya Pradesh": [37, 40, 23],
  Maharashtra: [36, 37, 27],
  Manipur: [23, 29, 48],
  Meghalaya: [30, 26, 44],
  Mizoram: [20, 45, 35],
  Nagaland: [24, 34, 42],
  ...
  Telangana: [24, 27, 49],
  Tripura: [28, 42, 30],
  "Uttar Pradesh": [20, 26, 54],
  Uttarakhand: [31, 44, 25],
};
